                                            ...
                                            $body = [
                                                ...
                                                $body = [
                                                    ...
                                                    if($config_shipit->configuration->automatic_delivery === false){
                                                        ...
                                                        $request_params['order']['origin']['street'] = ($address['street'] != '') ? $address['street'] : $order->get_billing_address_1();
                                                        $request_params['order']['origin']['number'] = $address['number'];
                                                        $request_params['order']['origin']['complement'] = (isset($address['numberAddition'])) ? $address['numberAddition'].'***'.$order->get_billing_address_2() : $order->get_billing_address_2();
                                                        $request_params['order']['origin']['commune_id'] = (int) filter_var($order->get_shipping_state(), FILTER_SANITIZE_NUMBER_INT);
                                                        $request_params['order']['origin']['full_name'] = $order->get_billing_first_name() . ' ' . $order->get_billing_last_name();
                                                        ...
                                                        $request_params['order']['origin']['number'] = $address['number'];
                                                        $request_params['order']['origin']['complement'] = (isset($address['numberAddition'])) ? $address['numberAddition'].'***'.$order->get_billing_address_2() : $order->get_billing_address_2();
                                                        $request_params['order']['origin']['commune_id'] = (int) filter_var($order->get_billing_state(), FILTER_SANITIZE_NUMBER_INT);
                                                        $request_params['order']['origin']['full_name'] = $order->get_billing_first_name() . ' ' . $order->get_billing_last_name();
                                                        $request_params['order']['origin']['email'] = $order->get_billing_email();
                                                        $request_params['order']['origin']['phone'] = $order->get_billing_phone();
                                                        $request_params['order']['origin']['store'] = false;
