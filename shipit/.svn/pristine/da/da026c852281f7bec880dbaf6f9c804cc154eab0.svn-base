...
= 2.2.7 =
*Adición de imgenes de plataforma y cambios de endpoint
...
= 2.2.4 =
*Envios costo cero resplazados por 'GRATIS'

= 2.2.3 =
*correccion calculo variaciones de tamaño unitario

= 2.2.2 =
*correccion tarificador de variaciones

= 2.2.1 =
*Se solvento un posible problema de bloqueo de ip

= 2.2.0 =
*Se cambiaron los estados de los pedidos y se solucionaron los problemas con los pedidos sin estados

= 2.1.1 =
*los pedidos que no se encuentren completados o en proceso no seran enviados

= 2.0.1 =
*se corrigen problemas con algunas imagenes

= 2.0 =
*Se crearon configuraciones de envio
