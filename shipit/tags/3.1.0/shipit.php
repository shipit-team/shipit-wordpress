...
function process_orders_pending_shipit($post_ids) {
  ...
  foreach ($post_ids as $post_id) {
    ...
    if ($order->is_paid()){
      ...
      if($notes[0]->content == 'El estado del pedido cambió de Procesando a Completado.' || $notes[0]->content == 'El estado del pedido cambió de Pendiente de pago a Procesando.' || $notes[0]->content == 'El estado del pedido cambió de Fallido a Procesando.'){
