                                            ...
                                            $body = [
                                                ...
                                                $body = [
                                                    ...
                                                    if($config_shipit->configuration->automatic_delivery === false){
                                                        ...
                                                        $request_params['order']['origin']['street'] = ($address['street'] != '') ? $address['street'] : $order->get_shipping_address_1();
                                                        $request_params['order']['origin']['number'] = $address['number'];
                                                        $request_params['order']['origin']['complement'] = (isset($address['numberAddition'])) ? $address['numberAddition'].'***'.$order->get_shipping_address_2() : $order->get_shipping_address_2();
                                                        $request_params['order']['origin']['commune_id'] = (int) filter_var($order->get_shipping_state(), FILTER_SANITIZE_NUMBER_INT);
                                                        $request_params['order']['origin']['full_name'] = $order->get_shipping_first_name() . ' ' . $order->get_shipping_last_name();
                                                        $request_params['order']['origin']['email'] = $order->get_billing_email();
                                                        $request_params['order']['origin']['phone'] = $order->get_billing_phone();
                                                        ...
                                                        $request_params['order']['destiny']['street'] = ($address['street'] != '') ? $address['street'] : $order->get_shipping_address_1();
                                                        $request_params['order']['destiny']['number'] = $address['number'];
                                                        $request_params['order']['destiny']['complement'] = (isset($address['numberAddition'])) ? $address['numberAddition'].'***'.$order->get_shipping_address_2() : $order->get_shipping_address_2();
                                                        $request_params['order']['destiny']['commune_id'] = (int) filter_var($order->get_shipping_state(), FILTER_SANITIZE_NUMBER_INT);
                                                        $request_params['order']['destiny']['commune_name'] = $name_comune;
                                                        $request_params['order']['destiny']['full_name'] = $order->get_shipping_first_name() . ' ' . $order->get_shipping_last_name();
                                                        $request_params['order']['destiny']['email'] = $order->get_billing_email();
