<?php
  class Destiny {
    ...
    public function __construct($full_name, $phone, $email, $address_stret, $address_number, $address_complement, $address_commune_id, $address_commune_name, $kind) {
      $this->full_name = $full_name;
      $this->phone = $phone;
      $this->email = $email;
      $this->$kind = $kind;
      $this->address = new Address($address_stret, $address_complement, $address_number, $address_commune_id, $address_commune_name);
    }
